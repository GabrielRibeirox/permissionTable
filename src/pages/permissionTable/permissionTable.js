...
//                 <input
//                   type="checkbox"
//                   checked={d.permission2}
//                   value='permission2'
//                   onChange={event => {
//                     let checked = event.target.checked;
//                     setPermissions(
//                       permissionState.map(data => {
//                         if (d.id === data.id) {
//                           data.select = checked;
//                         }
//                         return data;
...
//               </td>
  ...
  //       id={list.id}
  //       name={list.name}
  //       permissions={list.permissions.map(list => list)}
  //       title={list.class}
  //       row={list.background}
  //       checked={checked}
